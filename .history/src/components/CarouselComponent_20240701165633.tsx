...
const styles = StyleSheet.create({
  ...
  image: {
    width: viewportWidth * 0.6, // Set the width of the image
    height: viewportWidth * 0.6, // Set the height of the image (same as width for a circle)
    borderRadius: (viewportWidth * 0.6) / 2, // Make the image circular
    resizeMode: 'cover',
