...
const styles = StyleSheet.create({
  ...
  image: {
    width: viewportWidth * 0.8, // Set the width of the image
    height: viewportWidth * 0.8, // Set the height of the image (same as width for a circle)
    borderRadius: (viewportWidth * 0.2) / 2, // Make the image circular
    resizeMode: 'cover',
